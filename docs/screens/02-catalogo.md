...
- **Rota:** `/produtos` com `busca`, `categoria`, `marca` e `ordem` na URL.
...
- **Ações possíveis:** buscar, filtrar, ordenar, remover chips, abrir produto, favoritar e adicionar ao carrinho.
