...
export default function Header() {
  ...
  return (
    <div>
      <header className="fixed top-0 left-0 right-0 bg-gradient-to-b from-white to-gray-50 shadow-md z-50">
        {/* Barra Superior */}
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm">
                  Seg-Sex: {storeConfig.hours.weekdays}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Link
                href="/banho-e-tosa"
                className="text-text hover:text-primary transition-all hover:scale-105"
              >
                Banho e Tosa
              </Link>
              <Link
              ...
              {isAdmin && (
                <Link
                  ...
                  className="text-text hover:text-primary transition-all flex items-center gap-1 hover:scale-105"
                >
                  <GearSix size={18} />
                  Administração
                </Link>
                ...
                <div>
                  ...
                  {isSubmenuOpen && (
                    <div className="mt-2 ml-4 space-y-2">
                      <Link
                        href="/produtos/categoria/cao"
                        className="block text-sm text-text/80"
                      >
                        Cães
                      </Link>
                      <Link
