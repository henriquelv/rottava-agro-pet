...
const HistoryPage: NextPage = () => {
  ...
  const buscarHistorico = async (e: React.FormEvent) => {
    e.preventDefault();
  ...
  return (
    <Layout>
      <Head>
        <title>Histórico de Pedidos | Rottava Agro Pet</title>
        <meta name="description" content="Consulte seu histórico de compras na Rottava Agro Pet" />
      </Head>
      
      <main className="container mx-auto px-4 py-8 mt-16">
        <h1 className="text-3xl font-bold mb-6 text-center">Histórico de Pedidos</h1>
